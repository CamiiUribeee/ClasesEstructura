...
public class Menu extends javax.swing.JFrame {
    ...
    TallerClase objdobles = new TallerClase(); 
    ...
    private void insertarFinalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertarFinalActionPerformed
        objdobles.insertarAlFinal(JOptionPane.showInputDialog("Ingrese el nombre"), Integer.parseInt(JOptionPane.showInputDialog("Ingrese la edad")));
